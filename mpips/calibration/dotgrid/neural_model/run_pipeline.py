...
from mpips.calibration.dotgrid.neural_model.phantom import CENTER_MARKER_MODES
...
from mpips.calibration.dotgrid.neural_model.warp_image import CANVAS_MODE, warp_image
...
def cli():
    """Run the original aggregate calibration command-line pipeline."""
    ...
    parser.add_argument(
        "--opencv-out-dir", default=default_artifact_path("output/opencv_baseline")
    )
