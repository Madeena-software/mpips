...
class ImageJReplicator:
    ...
    def _normalize_imagej(
        ...
        return cast(np.ndarray, lut[image])
    ...
    def enhance_contrast(
        ...
        Args:
            ...
            saturated_pixels (float): Persentase piksel tersaturasi
                (Default ImageJ: 0.35).
    ...
    def _equalize_imagej_variant(
        ...
        # Terapkan LUT
        return cast(np.ndarray, lut[gray_image])
    ...
    def apply_clahe(
        ...
        Example:
            ...
            ...     image, blocksize=127, histogram_bins=256, max_slope=3.0
            ... )
        """
    ...
    def median_filter_imagej(
        ...
        return cast(np.ndarray, result.astype(original_dtype))
