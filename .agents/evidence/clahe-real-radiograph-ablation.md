...
The bounded experiment reused six complete identity blocks from the preserved checkpoint; 20 additional completed identities were excluded from primary analysis as `SUPPLEMENTAL / OUTSIDE PRIMARY BOUNDED COHORT`. The addendum revision is `7e5d28c0a1cad2c70fec57d634bbdc72fd62a07e`; the primary cohort is exactly 3 `Kepala` (`I-1-1`, `I-1-2`, `I-1-4`) and 3 `Tulang Belakang` (`I-1-1`, `I-1-2`, `I-1-3`). See `artifacts/real-data-regression/clahe-semantic-parameter-ablation.json` for the complete provenance, mapping inventory, candidate × case matrix, six-metric aggregates, paired deltas, intensity/clipping measurements, and exclusions.
